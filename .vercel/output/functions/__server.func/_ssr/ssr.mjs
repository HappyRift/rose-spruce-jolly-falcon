...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DP_jq_W9.mjs");
...
var manifest = {
	"44d60897f716321c594feb204f2df3c1eb78d3e1de8bee824b991da3b4607e96": {
		functionName: "completeChat_createServerFn_handler",
		importer: () => import("./complete-CumNBhU4.mjs")
	},
	"d870e16fb91cb1c9b0e020ad7ad4e18a61b98a647bd524416b43a9ffd41e2f0c": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DEGBjKzP.mjs").then((n) => n.t),
